...
%>
			<tr>
				...
				<td style="text-align: left"><a href="readDay.jsp?dnum=<%= dayList.getDay_num() %>">
...
<center>
	...
	<button class="button btn-danger" onclick="javascript:window.location='mydiary.jsp'">
	...
	<button class="button btn-danger" onclick="javascript:logout()">
